// PushServerStressTest_Client.cpp : 定义应用程序的类行为。
//
...
// CPushServerStressTest_ClientApp 构造
...
// 唯一的一个 CPushServerStressTest_ClientApp 对象

CPushServerStressTest_ClientApp theApp;


// CPushServerStressTest_ClientApp 初始化
