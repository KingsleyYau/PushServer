...
** pointer as an object.  The [sqlite3_open()], [sqlite3_open()], and
...
** from [sqlite3_open()], [sqlite3_open()], or
...
** or [sqlite3_open()] is used, then flags includes at least
...
** order for sqlite3_open(). ^(A [database connection] handle is usually
...
** UTF-16 in the native byte order if sqlite3_open() is used.
**
...
** sqlite3_open() and sqlite3_open().</dd>)^
** </dl>
**
...
** [sqlite3_open()].  The database connection must not have been closed.
**
...
** calls to [sqlite3_open()], [sqlite3_open_v2()], and [sqlite3_open()].
...
** is opened using [sqlite3_open()], [sqlite3_open()],
** or [sqlite3_open_v2()].
